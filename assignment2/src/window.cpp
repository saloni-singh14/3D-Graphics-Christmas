...
void Window :: drawWindow1(){
	///We draw windows using quadrilaterals and lines. We specify the vertices of the quadrilateral and its color. 
	/// Another window is drawn at a distance from the previous one on the same wall using drawWindow2()
	///
//Window 1
...
/// <summary>
/// Window Sill is drawn using quads. We specify the vertices of the quadrilateral and its color.
/// </summary>
glColor3f(0.149f, 0.149f, 0.149f);
glBegin(GL_QUADS);
glVertex3f(-9.99f, 2.0f, -6.0f);
